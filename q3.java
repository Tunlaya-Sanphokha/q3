...
public class q3{
  ...
  //playGame
    ...
    public static boolean check_win() {          
        ...
        for (int r = 0 ; r < 3 ; r ++){
            if( boardGame[r][0] == boardGame[r][1] && boardGame[r][1] == boardGame[r][2] && boardGame[r][0] != " "){
                printBoard();
        ...
        for (int c = 0 ; c < 3 ; c ++){
        if(boardGame[0][c] == boardGame[1][c]&& boardGame[1][c] == boardGame[2][c] &&  boardGame[0][c] != " "){
                printBoard();
                System.out.println("congrats"+ " " + player + " " +"win");
                return true;
            }
        ...
        if (boardGame[0][2] == boardGame[1][1] && boardGame[1][1] == boardGame [2][0] && boardGame[0][2] != " "){
            printBoard();
            System.out.println("congrats"+ " " + player + " " +"win");
            return true;
        }
